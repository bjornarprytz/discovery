...
func cycle_quest():
    ...
    ## TODO: Maybe use this in the quest duration, or remove it
    var vertical_difference = (next_quest.start_idx / Corpus.corpus_line_length) - (current_pos / Corpus.corpus_line_length)
    var horizontal_difference = (next_quest.start_idx % Corpus.corpus_line_length) - (current_pos % Corpus.corpus_line_length)
